...
export function CreateMessageForm() {
  ...
  return (
    <form
      ...
      className="flex items-center gap-2 bg-zinc-900 p-2 rounded-xl border border-zinc-900 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1"
    >
      <input
        type="text"
        name="message"
